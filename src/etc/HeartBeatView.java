...
import healthcare.demand.ppg.PPG_hrm;
...
public class HeartBeatView extends View {
    ...
    public HeartBeatView(Context context, AttributeSet attr) {
        ...
        greenBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.heart_small);
        redBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.heart_big);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap = null;
        if (PPG_hrm.getCurrent() == PPG_hrm.TYPE.GREEN) bitmap = greenBitmap;
